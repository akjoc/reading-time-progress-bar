...
== Screenshots ==
1. The progress bar displayed on a blog post.
2. Settings page allowing customization (if applicable).
...
== Upgrade Notice ==
= 1.0 =
* Enjoy the new features and enhancements with this initial release!
